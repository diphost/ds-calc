...
import (
        ...
        "hash"
        "crypto/sha256"
        "cypherpunks.ru/gogost/gost28147"       // http://www.cypherpunks.ru/gogost/ >=2.0 requires
...
// flags         - uint16 the flags of the DNSKEY (always 257)
// protocol      - uint8, the protocol of the DNSKEY (always 3)
// algorithm     - uint8, the algorithm of the DNSKEY (8, 10, 12, 13 or 14)
// publickey     - string, the full publickey base64 encoded (care, no spaces allowed)
// digest_alg    - int, the hash algorithm for the DS digest (const SHA256, GOST_CRYPTO or SHA384)
//
...
func main() {
        ...
        fmt.Println("TEST:   example.com. IN DS 20545 13 2 E460EAB7D69ABDE51078BC27CE8377074CA94EE05F5A609E5593C5E25ACF2BF4")
        ...
        fmt.Println("TEST:   example.com. IN DS 20545 13 3 9B8E8392B2C8203CEC672AE891329221678CE06E5FE861DB61688F0C1CA0B494")
        fmt.Printf("CACL:   %s IN DS %d %d 3 %s\n\n", d.domain, keytag, d.algorithm, digest)
        keytag, digest = calc_ds(d.domain, d.flags, d.protocol, d.algorithm, d.publickey, SHA384)
        fmt.Println("TEST:   example.com. IN DS 20545 13 4 99436F3FB883CA4F077798C206037D97A34560245E57F1FFB10222B12AB8BD73755B1C41BFF6CF039E942CD3CB3950C1")
